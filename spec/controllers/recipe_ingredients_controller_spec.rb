...
RSpec.describe RecipeIngredientsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all recipe_ingredients as @recipe_ingredients" do
      ...
      expect(assigns(:recipe_ingredients)).to eq([recipe_ingredient])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested recipe_ingredient as @recipe_ingredient" do
      recipe_ingredient = RecipeIngredient.create! valid_attributes
      get :show, params: {id: recipe_ingredient.to_param}, session: valid_session
      expect(assigns(:recipe_ingredient)).to eq(recipe_ingredient)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested recipe_ingredient as @recipe_ingredient" do
      recipe_ingredient = RecipeIngredient.create! valid_attributes
      get :edit, params: {id: recipe_ingredient.to_param}, session: valid_session
      expect(assigns(:recipe_ingredient)).to eq(recipe_ingredient)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created recipe_ingredient as @recipe_ingredient" do
        post :create, params: {recipe_ingredient: valid_attributes}, session: valid_session
        expect(assigns(:recipe_ingredient)).to be_a(RecipeIngredient)
        expect(assigns(:recipe_ingredient)).to be_persisted
      end
